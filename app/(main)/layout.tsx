...
@version 2026.1.12
@timestamp 2026-01-12T05:25:37.393Z
...
/**
 * 🛰️ SYSTEM_PROTOCOL: MAIN_GROUP_LAYOUT_CORE
 * VERSION: 1.3.0 (Pure_Wrapper_Isolation)
 * ✅ Strategy: Decoupled Navigation for Specialized Scenes
 */
...
export default function MainLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex min-h-screen flex-col bg-white">
      {/* 🌌 SCENE_CONTAINER: 
          ถอด Header/Footer ออกแล้ว เพื่อให้ Page ด้านในกำหนดเอง 
          หรือใช้ร่วมกับ Middleware/Conditional Rendering ในภายหลัง
      */}
      <main className="relative flex flex-1 flex-col">
        {/* 📍 CONTENT_ZONE:
            รักษาระดับ Max-width และ Padding พื้นฐานเพื่อให้ UI ไม่กระจัดกระจาย
        */}
        <div className="mx-auto w-full max-w-7xl flex-1 px-4 sm:px-6 lg:px-8">{children}</div>
      </main>
    </div>
  )
}
