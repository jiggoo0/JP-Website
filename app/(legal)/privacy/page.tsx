...
@version 2026.1.12
@timestamp 2026-01-12T05:25:37.410Z
...
export default function PrivacyPage() {
  return (
    <article className="prose prose-slate max-w-none">
      <h1 className="mb-8 text-4xl font-black uppercase italic tracking-tighter text-[#020617]">
        Privacy_Policy
      </h1>

      <section className="space-y-6 leading-relaxed text-slate-600">
        <p className="font-bold text-[#020617]">
          นโยบายความเป็นส่วนตัวนี้จัดทำขึ้นเพื่อชี้แจงรายละเอียดเกี่ยวกับการเก็บรวบรวม การใช้
          และการคุ้มครองข้อมูลส่วนบุคคลของคุณภายใต้มาตรฐานความปลอดภัยสูงสุด
        </p>

        <h3 className="border-l-4 border-[#FCDE09] pl-4 text-xl font-black text-[#020617]">
          1. ข้อมูลที่เราจัดเก็บ (DATA_COLLECTION)
        </h3>
        <p>
          เราจัดเก็บข้อมูลที่จำเป็นต่อการให้บริการตรวจสอบเอกสารและการติดต่อประสานงาน รวมถึง:
          ชื่อ-นามสกุล, ข้อมูลการติดต่อ, และข้อมูลทางเทคนิค (IP Address, User Agent) ตามมาตรฐาน
          Protocol v3.3.1
        </p>

        <h3 className="border-l-4 border-[#FCDE09] pl-4 text-xl font-black text-[#020617]">
          2. การรักษาความปลอดภัย (SECURITY_PROTOCOL)
        </h3>
        <p>
          ข้อมูลทั้งหมดจะได้รับการเข้ารหัสและจำกัดสิทธิ์การเข้าถึงเฉพาะผู้ที่เกี่ยวข้อง โดยระบบ
          Verify ของเราจะทำ Masking ข้อมูลเพื่อความปลอดภัยสูงสุดของเจ้าของข้อมูล
        </p>
      </section>
    </article>
  )
