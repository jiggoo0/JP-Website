...
@version 2026.1.12
@timestamp 2026-01-12T05:25:37.364Z
...
/**
 * 🛰️ UI_PROTOCOL: STRUCTURAL_SEPARATOR
 * VERSION: 1.1.0
...
>(({ className, orientation = 'horizontal', decorative = true, ...props }, ref) => (
  <SeparatorPrimitive.Root
    ...
    className={cn(
      'shrink-0 bg-[#020617]/10', // ปรับสีพื้นฐานให้เข้ากับโทน Dark Slate
      orientation === 'horizontal'
        ? 'h-[2px] w-full' // เพิ่มความหนาเป็น 2px เพื่อความดุดัน
        : 'h-full w-[2px]', // เพิ่มความหนาเป็น 2px สำหรับแนวตั้ง
      className,
    )}
    {...props}
  />
