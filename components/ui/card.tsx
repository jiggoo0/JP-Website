...
@version 2026.1.12
@timestamp 2026-01-12T05:25:37.369Z
...
/**
 * 🛰️ UI_PROTOCOL: DATA_CONTAINER_PROTOCOL
 * VERSION: 1.3.0
 * ✅ Theme: Bold_Borders & Hard_Shadows
 */
...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'rounded-none border-4 border-[#020617] bg-white text-[#020617] shadow-[8px_8px_0px_0px_rgba(2,6,23,1)] transition-all',
        className,
      )}
      {...props}
    />
...
const CardHeader = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('flex flex-col space-y-2 border-b-2 border-slate-100 p-8', className)}
      {...props}
    />
  ),
)
...
const CardDescription = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn('text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400', className)}
      {...props}
    />
  ),
)
...
const CardFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('flex items-center gap-4 p-8 pt-0', className)} {...props} />
  ),
)
