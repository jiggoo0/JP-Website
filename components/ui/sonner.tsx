...
@version 2026.1.12
@timestamp 2026-01-12T05:25:37.362Z
...
/**
 * 🛰️ UI_PROTOCOL: NOTIFICATION_DISPATCH_SYSTEM
 * VERSION: 1.2.0
 * ✅ Theme: High_Contrast_Alerts, Sharp_Edges
 */
...
const Toaster = ({ ...props }: ToasterProps) => {
  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          // 🛡️ TOAST_CORE: เปลี่ยนเป็นขอบหนา 4px และไม่มีความโค้งมน (rounded-none)
          toast:
            'group toast group-[.toaster]:rounded-none group-[.toaster]:border-4 group-[.toaster]:border-[#020617] group-[.toaster]:bg-white group-[.toaster]:text-[#020617] group-[.toaster]:shadow-[8px_8px_0px_0px_rgba(252,222,9,1)] group-[.toaster]:font-bold',
          // 📝 DESCRIPTION: ปรับฟอนต์ให้ดูเป็นทางการ
          description:
            'group-[.toast]:text-slate-500 group-[.toast]:font-medium group-[.toast]:italic',
          // 🔘 ACTION_BUTTON: สไตล์ปุ่มกดอุตสาหกรรม
          actionButton:
            'group-[.toast]:bg-[#020617] group-[.toast]:text-[#FCDE09] group-[.toast]:rounded-none group-[.toast]:font-black group-[.toast]:uppercase group-[.toast]:text-[10px]',
          // ❌ CANCEL_BUTTON:
          cancelButton:
            'group-[.toast]:bg-slate-100 group-[.toast]:text-[#020617] group-[.toast]:rounded-none group-[.toast]:font-bold',
        },
      }}
      {...props}
    />
